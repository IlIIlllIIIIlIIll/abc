...
String pathway, jDeci, ohMyGodSFX, beepSFX, zeAhSFX; //the songs/SFX
...
void setupAudio() {
  ...
  soundEffects[1] = minim.loadFile( pathway + zeAhSFX ); //sound effect
...
void concatenationOfMusicFiles() {
  ...
  zeAhSFX = "positive-tone-man-says-great-209738.mp3";
